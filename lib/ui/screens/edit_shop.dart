...
class _EditShopState extends State<EditShop> {
  ...
  Future<void> _saveForm() async {
    ...
    try {
      final shopManager = context.read<ShopManager>();
      if (_editedProduct.id != null) {
        await shopManager.updateProduct(_editedProduct);
      } else {
        await shopManager.addProduct(_editedProduct);
      }
    } catch (error) {
